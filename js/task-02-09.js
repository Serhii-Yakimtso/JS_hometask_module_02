...
// и верни true или false в зависимости от того, попадает ли длина параметра в заданный диапазон от 4 - х до 16 - ти символов включительно.

// Напиши функцию isLoginUnique(allLogins, login), которая принимает список всех логинов и добавляемый логин
// как параметры и проверяет наличие login в массиве allLogins, возвращая true если такого логина еще нет и false если логин уже используется.
...
function isLoginValid(login, min = 4, max = 16) {
  ...
  // console.log("попадание в размер", login.length >= min && login.length <= max);
...
function isLoginUnique(allLogins, login) {
  ...
  // console.log("Логин используется", logins.includes(login));
...
function addLogin(allLogins, login) {
  ...
  // console.log(logins[6]);
  // console.log(logins[1] === logins[6]);
